...
class UserCardAdapter(private val list: List<UserCardModel>, var editMode: Boolean, private val userCardAction: UserCardAction) : RecyclerView.Adapter<UserCardViewHolder>() {
    ...
    override fun onBindViewHolder(holder: UserCardViewHolder, position: Int) {
        ...
        holder.bind(userCardModel,editMode, userCardAction)
    }
